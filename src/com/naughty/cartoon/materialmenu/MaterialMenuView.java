...
package com.naughty.cartoon.materialmenu;

import static com.naughty.cartoon.materialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.naughty.cartoon.materialmenu.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.naughty.cartoon.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.naughty.cartoon.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
...
import com.naughty.cartoon.materialmenu.MaterialMenuDrawable.IconState;
...
public class MaterialMenuView extends View implements MaterialMenu {
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		try {
			...
			int transformDuration = attr.getInteger(R.styleable.MaterialMenuView_mm_transformDuration,
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			widthMeasureSpec = MeasureSpec
					.makeMeasureSpec(drawable.getIntrinsicWidth() + paddingX, MeasureSpec.EXACTLY);
			heightMeasureSpec = MeasureSpec.makeMeasureSpec(drawable.getIntrinsicHeight() + paddingY,
					MeasureSpec.EXACTLY);
	...
	private void adjustDrawablePadding() {
		if (drawable != null) {
			drawable.setBounds(0, 0, drawable.getIntrinsicWidth() + getPaddingLeft() + getPaddingRight(),
